...
void Method1()
{
    Console.WriteLine("Автор проекта Орлова А.Ю.");
}
Method1();
*/
...
/*
// Работа с текстом
// Дан текст. В тексте нужоно все пробелы заменить черточками,
...
// дз - сортировка элементов массива от большего к меньшему
int[] arr = {1, 5, 4, 3, 2, 6, 7, 1, 1};
void PrintArray (int[] array)
{
    int count = array.Length;
